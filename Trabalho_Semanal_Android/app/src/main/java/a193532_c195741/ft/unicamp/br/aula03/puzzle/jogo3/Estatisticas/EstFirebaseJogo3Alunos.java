...
public class EstFirebaseJogo3Alunos extends AsyncTask<String, Void, String> {

    int numArgs;
    EstatFrasesAluno fragment;

    public EstFirebaseJogo3Alunos(EstatFrasesAluno fragment) {
    ...
    protected void onPostExecute(String args) {
        if(numArgs != 3){
            try {
                ...
                fragment.atualizaLayoult(jsonObject);
