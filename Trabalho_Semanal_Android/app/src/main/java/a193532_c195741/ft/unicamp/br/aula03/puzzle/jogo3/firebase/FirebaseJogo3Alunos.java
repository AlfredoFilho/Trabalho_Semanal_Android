package a193532_c195741.ft.unicamp.br.aula03.puzzle.jogo3.firebase;
...
public class FirebaseJogo3Alunos extends AsyncTask<String, Void, String> {

    int numArgs;
    AlunosFraseFragment fragment;

    public FirebaseJogo3Alunos(AlunosFraseFragment fragment) {
